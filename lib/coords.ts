...
export const COORDS = {
  ...
  GL_EXP_DATE:           declare('GL_EXP_DATE',      { anchor: 'COMMERCIAL GENERAL LIABILITY', side: 'row', dx: 380, dy: -6, size: 7.5 }),
  GL_LIMIT_EACH_OCC:     declare('GL_LIMIT_EACH_OCC',     { anchor: 'EACH OCCURRENCE',         side: 'row', dx: 523, dy: 0, size: 7.5, maxWidth: 60, nearY: 482 }),
  GL_LIMIT_DAMAGE_RENT:  declare('GL_LIMIT_DAMAGE_RENT',  { anchor: 'DAMAGE TO RENTED',        side: 'row', dx: 523, dy: -6, size: 7.5, maxWidth: 60 }),
  ...
  AUTO_EXP_DATE:          declare('AUTO_EXP_DATE',      { anchor: 'AUTOMOBILE LIABILITY', side: 'row', dx: 380, dy: -6, size: 7.5 }),
  ...
  WC_EFF_DATE:          declare('WC_EFF_DATE',      { anchor: 'WORKERS COMPENSATION', side: 'row', dx: 334, dy: -9, size: 7.5 }),
  WC_EXP_DATE:          declare('WC_EXP_DATE',      { anchor: 'WORKERS COMPENSATION', side: 'row', dx: 380, dy: -9, size: 7.5 }),
  ...
  OTHER_DESCRIPTION:   declare('OTHER_DESCRIPTION',   { anchor: 'E.L. DISEASE - POLICY LIMIT', side: 'row', dx:  52, dy: -26, size: 7.5, maxWidth: 155 }),
  ...
  OTHER_EFF_DATE:      declare('OTHER_EFF_DATE',      { anchor: 'E.L. DISEASE - POLICY LIMIT', side: 'row', dx: 334, dy: -26, size: 7.5 }),
  OTHER_EXP_DATE:      declare('OTHER_EXP_DATE',      { anchor: 'E.L. DISEASE - POLICY LIMIT', side: 'row', dx: 380, dy: -26, size: 7.5 }),
