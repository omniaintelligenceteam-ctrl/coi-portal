...
export const COORDS = {
  ...
  CONTACT_PHONE: declare('CONTACT_PHONE', { anchor: 'PHONE', side: 'right', dx: 18, dy: -2.5, size: 7.5, maxWidth: 100 }),
  ...
  // ====================================================================
  GL_CHK_TYPE:           declare('GL_CHK_TYPE',         { anchor: 'COMMERCIAL GENERAL LIABILITY', side: 'left', dx: -6.5, dy: 1.5, size: 9 }),
  GL_CHK_OCCUR:          declare('GL_CHK_OCCUR',        { anchor: 'OCCUR',                        side: 'left', dx: -6.5, dy: 1.5, size: 9, nearY: 470 }),
  GL_CHK_AGG_POLICY:     declare('GL_CHK_AGG_POLICY',   { anchor: 'POLICY',                       side: 'left', dx: -6.5, dy: 1.5, size: 9, nearY: 422 }),
  ...
  GL_EFF_DATE:           declare('GL_EFF_DATE',      { anchor: 'COMMERCIAL GENERAL LIABILITY', side: 'row', dx: 328, dy: -6, size: 7.5 }),
  GL_EXP_DATE:           declare('GL_EXP_DATE',      { anchor: 'COMMERCIAL GENERAL LIABILITY', side: 'row', dx: 374, dy: -6, size: 7.5 }),
  GL_LIMIT_EACH_OCC:     declare('GL_LIMIT_EACH_OCC',     { anchor: 'EACH OCCURRENCE',         side: 'row', dx: 523, dy: 0, size: 7.5, maxWidth: 60, nearY: 482 }),
  GL_LIMIT_DAMAGE_RENT:  declare('GL_LIMIT_DAMAGE_RENT',  { anchor: 'DAMAGE TO RENTED',        side: 'row', dx: 523, dy: -8, size: 7.5, maxWidth: 60 }),
  ...
  AUTO_EFF_DATE:          declare('AUTO_EFF_DATE',      { anchor: 'AUTOMOBILE LIABILITY', side: 'row', dx: 328, dy: -6, size: 7.5 }),
  AUTO_EXP_DATE:          declare('AUTO_EXP_DATE',      { anchor: 'AUTOMOBILE LIABILITY', side: 'row', dx: 374, dy: -6, size: 7.5 }),
  ...
  UMB_EFF_DATE:       declare('UMB_EFF_DATE',      { anchor: 'UMBRELLA LIAB', side: 'row', dx: 328, dy: -6, size: 7.5 }),
  UMB_EXP_DATE:       declare('UMB_EXP_DATE',      { anchor: 'UMBRELLA LIAB', side: 'row', dx: 374, dy: -6, size: 7.5 }),
  ...
  // ====================================================================
  WC_CHK_PER_STATUTE:   declare('WC_CHK_PER_STATUTE', { anchor: 'PER', side: 'left', dx: -6.5, dy: 1.5, size: 9 }),
  ...
  WC_EFF_DATE:          declare('WC_EFF_DATE',      { anchor: 'WORKERS COMPENSATION', side: 'row', dx: 328, dy: -9, size: 7.5 }),
  WC_EXP_DATE:          declare('WC_EXP_DATE',      { anchor: 'WORKERS COMPENSATION', side: 'row', dx: 374, dy: -9, size: 7.5 }),
  ...
  OTHER_EFF_DATE:      declare('OTHER_EFF_DATE',      { anchor: 'E.L. DISEASE - POLICY LIMIT', side: 'row', dx: 328, dy: -26, size: 7.5 }),
  OTHER_EXP_DATE:      declare('OTHER_EXP_DATE',      { anchor: 'E.L. DISEASE - POLICY LIMIT', side: 'row', dx: 374, dy: -26, size: 7.5 }),
